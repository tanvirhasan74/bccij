...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div >
                <img src="{{asset('images/10.png')}}" style="width: 200px">
                <br>
                <span>Mr. Badal Chaklader</span>
                <br>
                <span>President, BCCIJ</span>
            </div>
            <div>
                <p>
                    {{\Illuminate\Support\Facades\File::get(base_path() . '/public/messages/president.txt')}}
                </p>
            </div>
        </div>
